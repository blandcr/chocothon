...
//this updates the world, if you didn't know
short update_world(
	void)
{
...
//this loads the game sounds. ain't i a smartass
	...
	short environment_code)
{
	...
	{
		case 0:
			load_sounds((short *) &preload_sounds0, NUMBER_OF_PRELOAD_SOUNDS0);
			break;
		case 1:
			load_sounds((short *) &preload_sounds1, NUMBER_OF_PRELOAD_SOUNDS1);
			break;
		default:
			break;
	}
