...
-------------------------------------------
Thursday, November 23, 2017 8:58 PM
	commented out InputSprocket,Classic Mac and 68k/ppc code.
	gawked at inconsistency of jason jones's switch statements.
	...
	void)
{
	...
	//if the game is being played on a mac slower than a 68040 processor
	...
	void)
{
	...
	if(!err)
	{
		...
		{
			case gestaltCPU68000: case gestaltCPU68010: case gestaltCPU68020: case gestaltCPU68030:
...
static struct keyword_data keywords[]=
{
	...
	{_tag_toaster, "TOAST"},
	{_tag_fusion, "MELT"},
	{_tag_pzbxay, "PZBXAY"}, // the alien shotgun, in the phfor's language
	{_tag_ammo, "AMMO"},
	{_tag_jump, "QWE"},
	{_tag_aslag, "SHIT"},
	{_tag_save, "YOURMOM"},
	...
	switch (event->what)
	{
		case mouseDown:
			...
			switch (part_code)
			{
				...
				default:
					//vhalt??? also, i think csprintf is a cseries thing
